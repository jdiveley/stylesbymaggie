...
const inputCls = 'w-full px-3 py-2.5 border border-sage-600/30 bg-[#0d1a0f]/60 rounded-xl text-sm text-sage-100 placeholder-sage-600 focus:outline-none focus:border-sage-400/60'
